...
JSONRpcClient.getHTTPRequest = function ()
{
  ...
  throw new JSONRpcClient.Exception(
    ...
    //  add JSON-RPC class to Clearly global object
    //  ===========================================
        __readable_by_evernote.JSONRpcClient = JSONRpcClient;

        
    //  custom error handler
    //  ====================

        //  default is a pretty bad one -- which sometimes doesn't actually work
        //  __readable_by_evernote.JSONRpcClient.toplevel_ex_handler = JSONRpcClient.default_ex_handler;
        
        //  custom
        __readable_by_evernote.JSONRpcClient.toplevel_ex_handler = function (_e)
        {
            //  to console
            //  if (console && console.log) { console.log(_e); }
            
            //  to firebug
            //  if (Firebug && Firebug.Console && Firebug.Console.log) { Firebug.Console.log(_e); }
            
            //  alert it
            //alert(_e);
            
            try { console.log(_e); console.log(_e.toString()); } catch (e) {}
        };
